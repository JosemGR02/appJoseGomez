    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg navbar-light  bg-secondary">
            <div className="container-fluid">
                <a className="navbar-brand" href="#"><img src="../img/Dynamyte.png" width="200px" alt="logo Buzoz"/></a>
                ...
                <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="./Paginas/registrarse.html">registrarse</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="./paginas/contactanos.html">Contactanos</a>
                        </li>
                    </ul>
                    <form className="d-flex">
                        ...
                        <div>
                            <button id="botonregistrar" className= "btn-outline-secondary" type="submit"><a className="nav-link" href="./paginas/registrarse.html"><i className="bi bi-person-fill fs-4"></i></a></button>
                        </div>
                        <div>
                            <button id="botoncarrito" className="btn-outline-secondary" type="submit"><a className="nav-link" href="./paginas/carritocompras.html"><i className="bi bi-cart fs-4"></i></a></button>
                        </div>
                    </form>
                </div>
            </div>
